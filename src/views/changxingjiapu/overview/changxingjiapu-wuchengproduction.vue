<template>
  <el-container class="container" :style="elMainBG">
    ...
    <!-- <div class="header-right">
      <el-button type="text" style="color: #fff" @click="toSecondVer()">查看前一日汇总统计</el-button>
    </div> -->
    <div class="banner">
          ...
          <ul class="menu-one-ul">
            ...
            <li class="menu-one-li">
              <div>
                ...
                <div class="icon-right">
                  <p>
                    当日总原丝耗用<span class="count1" id="count4"><countTo
                    :startVal="0"
                    :endVal="data2.dqty"
                    :duration="2000"
                    :decimals="2"
            ...
            <li class="menu-one-li">
              <div>
                ...
                <div class="icon-right">
                  <p>入驻企业<span class="count2" id="count16">5</span>个</p>
                  <p>织机总数<span class="count2" id="count17">528</span>台</p>
                  <p>织机运转<span class="count1" id="count18">488</span>台</p>
                </div>
              </div>
            </li>
            <li class="menu-one-li">
              <div>
                ...
                <div class="icon-right">
                  <p>
                    当日织机开机率<span class="count1" id="count19"><countTo
                    :startVal="0"
                    :endVal="92.42"
                    :duration="2000"
                    :decimals="2"
              ...
              <div>
                ...
                <div class="icon-right environment">
                  ...
                  <p>总磷<span class="count1" id="count31"><countTo
                    ...
                    :decimals="1"
                  ></countTo></span></p>
                  <p>化学需氧量<span class="count1" id="count32"><countTo
                    :startVal="0"
            ...
            <li class="menu-one-li">
              <div>
                ...
                <div class="icon-right">
                  <p>
                    接入条码企业<span class="count2" id="count33">5</span>个
                  </p>
                  <p>
                    总有效条码数<span class="count2" id="count34">{{data5.packqtysum}}</span>卷
                  </p>
                  <p>
                    条码验证请求<span class="count2" id="count35"><countTo
                    :startVal="0"
                    :endVal="0"
                    :duration="2000"
                  ></countTo></span>万次
    ...
    <div class="bottom-content">
      ...
      <div class="bottom-smilebox">
        ...
        <dir class="footer">
          ...
          <!-- <div class="footer-button" :style="parkCardBG" @click="towcpark()">
            <img src="@/assets/images/icon/底部ICON/icon_1.png" alt=""/>
            <div>吴城园区总览</div>
          </div> -->
...
export default {
  ...
  methods: {
    ...
    GetSilkSilkExpendVarietiesData() {
      this.$store
        .dispatch("silk/SilkExpendVarieties", { park: "wucheng" })
        .then(
          (res) => {
            if (res.data.length > 0) {
              for (var i = 0; i < res.data.length; i++) {
    ...
    GetGreyProductionDetailData() {
      this.$store
        .dispatch("greige/GreyProductionDetail", { park: "wucheng" })
        .then(
          (res) => {
            if (res.data.length > 0) {
              for (var i = 0; i < res.data.length; i++) {
    ...
    GetGreySaleVarietiesData() {
      this.$store
        .dispatch("greige/GreySaleVarieties", { park: "wucheng" })
        .then(
          (res) => {
            if (res.data.length > 0) {
              for (var i = 0; i < res.data.length; i++) {
    ...
    GetIndividualGreyProData() {
      this.$store
        .dispatch("greige/IndividualGreyPro", { park: "wucheng" })
        .then(
          (res) => {
            if (res.data.length > 0) {
              this.list2 = res.data;
