<template>
  <el-container class="container" :style="elMainBG">
    ...
    <el-header>
      <xiaoweiyuanHeader title="浙江鑫涛科技股份有限公司纺织中心" ></xiaoweiyuanHeader>
    </el-header>
          ...
          <ul class="menu-one-ul">
            <li class="menu-one-li">
              <div>
                ...
                <div class="icon-right">
                  <p>当日总采购<span class="count1" id="count1"><countTo
                    :startVal="0"
                    :endVal="data1.dqty"
                    :duration="2000"
                    :decimals="2"
            ...
            <li class="menu-one-li">
              <div>
                ...
                <div class="icon-right">
                  <p>
                    当日总原丝耗用<span class="count1" id="count4"
                  ><countTo
                    :startVal="0"
                    :endVal="data2.dqty"
                    :duration="2000"
            ...
            <li class="menu-one-li">
              <div>
                ...
                <div class="icon-right">
                  <p>
                    当日总坯布产出<span class="count1" id="count7"><countTo
                    :startVal="0"
                    :endVal="data3.dqty"
                    :duration="2000"
                    :decimals="2"
            ...
            <li class="menu-one-li">
              <div>
                ...
                <div class="icon-right">
                  <p>
                    当日总销售<span class="count1" id="count10"><countTo
                    :startVal="0"
                    :endVal="data4.dqty"
                    :duration="2000"
                    :decimals="2"
            ...
            <li class="menu-one-li">
              <div>
                ...
                <div class="icon-right">
                  <!--                  <p>入驻企业<span class="count2" id="count16">11</span>个</p>-->
                  <!-- <p>入驻企业<span class="count2" id="count16">11</span>个</p> -->
                  <p>
                    织机总数<span class="count2" id="count17"
                  ><countTo
                    :startVal="0"
                    :endVal="270"
                    :duration="2000"
                  ...
                  <!--                  </p>-->
                  <p>
                    织机运转<span class="count1" id="count18"
                  ><countTo
                    :startVal="0"
                    :endVal="257"
                    :duration="2000"
            ...
            <li class="menu-one-li">
              <div>
                ...
                <div class="icon-right">
                  <p>
                    当日织机开机率<span class="count1" id="count19"
                  ><countTo
                    :startVal="0"
                    :endVal="95.19"
                    :duration="2000"
                  ...
                  <p>
                    月均织机开机率<span class="count2" id="count20"
                  ><countTo
                    :startVal="0"
                    :endVal="93.8"
                    :duration="2000"
            ...
            <li class="menu-one-li">
              <div>
                ...
                <div class="icon-right">
                  <p>当日总水量<span class="count1" id="count21"><countTo
                    :startVal="0"
                    :endVal="data6.dqty"
                    :duration="2000"
                  ></countTo></span>吨
            ...
            <li class="menu-one-li">
              <div>
                ...
                <div class="icon-right">
                  <p>当日总电量<span class="count1" id="count24"><countTo
                    :startVal="0"
                    :endVal="data7.dqty"
                    :duration="2000"
                  ></countTo></span>度
            ...
            <li class="menu-one-li">
              <div>
                ...
                <div class="icon-right">
                  ...
                  <p>
                    总有效条码数<span class="count2" id="count34"
                  ><countTo
                    :startVal="0"
                    :endVal="data5.packqtysum"
                    :duration="2000"
    ...
    <div class="mid-content">
      <div class="mid-box" :style="menuThreeBG">
        ...
        <Table
          :title="labelList1"
          :data="list1"
          style="width: 90%; height: 12rem; margin: 0 auto; margin-top: 2rem;"
        ></Table>
        <!--          <div class="listtitle">-->
      ...
      <div class="mid-box" :style="menuThreeBG">
        <div class="title">平台企业本年织机产量统计</div>
        <Table
          :title="labelList2"
          :data="list2"
          style="width: 95%; height: 12rem; margin: 0 auto; margin-top: 2rem;"
        ></Table>
...
export default {
  ...
  data() {
    return {
      ...
      list2: [
        {epsname:'001',name:'1#喷气织机',qty:'28650'},
        {epsname:'',name:'2#喷气织机',qty:'28650'},
        {epsname:'',name:'3#喷气织机',qty:'28650'},
        {epsname:'',name:'4#喷气织机',qty:'27860'},
        {epsname:'',name:'5#喷气织机',qty:'24580'},
        {epsname:'',name:'6#喷气织机',qty:'26560'},
        {epsname:'',name:'7#喷气织机',qty:'27860'},
        {epsname:'',name:'8#喷气织机',qty:'23560'},
        {epsname:'',name:'9#喷气织机',qty:'24980'},
        {epsname:'',name:'10#喷气织机',qty:'26530'},
      ],
      count1: "0",
      count2: "0",
      count3: "0",
  ...
  methods: {
    ...
    GetSilkProductionData() {
      this.$store.dispatch("silk/SilkProduction", { park: "wucheng" }).then(
        (res) => {
          if (res.data.length == 1) {
            this.data1.dqty = res.data[0].dqty;
            this.data1.mqty = res.data[0].mqty;
            this.data1.yqty = res.data[0].yqty;
          } else {
            // this.$message({
            //   message: "暂无数据",
            //   type: "warning",
    ...
    //原丝耗用统计
    GetSilkExpendData() {
      this.$store.dispatch("silk/SilkExpend", { park: "wucheng" }).then(
        (res) => {
          if (res.data.length == 1) {
            // this.data2 = res.data[0];
            this.data2.dqty = res.data[0].dqty;
            this.data2.mqty = res.data[0].mqty;
            this.data2.yqty = res.data[0].yqty;
          } else {
            // this.$message({
            //   message: "暂无数据",
            //   type: "warning",
    ...
    GetSilkExpendDetailData() {
      this.$store.dispatch("silk/SilkExpendDetail", { park: "wucheng" }).then(
        (res) => {
    ...
    GetSilkSilkExpendVarietiesData() {
      this.$store.dispatch("silk/SilkExpendVarieties", { park: "wucheng" }).then(
        (res) => {
          if (res.data.length > 0) {
            for (var i = 0; i < res.data.length; i++) {
    ...
    GetGreyProductionData() {
      this.$store.dispatch("greige/GreyProduction", { park: "wucheng" }).then(
        (res) => {
          if (res.data.length == 1) {
    ...
    //坯布销售统计
    GetGreySaleData() {
      this.$store.dispatch("greige/GreySale", { park: "wucheng" }).then(
        (res) => {
          if (res.data.length == 1) {
    ...
    //坯布库存总数量和总卷数，总品种
    GetGreySummaryData() {
      this.$store.dispatch("greige/GreySummary", { park: "wucheng" }).then(
        (res) => {
          if (res.data.length == 1) {
    ...
    GetGreyProductionDetailData() {
      this.$store.dispatch("greige/GreyProductionDetail", { park: "wucheng" }).then(
        (res) => {
          if (res.data.length > 0) {
            for (var i = 0; i < res.data.length; i++) {
    ...
    GetGreySaleDetailData() {
      this.$store.dispatch("greige/GreySaleDetail", { park: "wucheng" }).then(
        (res) => {
          if (res.data.length > 0) {
            for (var i = 0; i < res.data.length; i++) {
    ...
    GetGreySaleVarietiesData() {
      this.$store.dispatch("greige/GreySaleVarieties", { park: "wucheng" }).then(
        (res) => {
          if (res.data.length > 0) {
            for (var i = 0; i < res.data.length; i++) {
    ...
    GetIndividualGreyProData() {
      this.$store.dispatch("greige/IndividualGreyPro", { park: "wucheng" }).then(
        (res) => {
          if (res.data.length > 0) {
            // this.list2 = res.data;
          } else {
    ...
    //当前坯布库存统计
    GetGreyVrtItyData() {
      this.$store.dispatch("greige/GreyVrtIty", { park: "wucheng" }).then(
        (res) => {
          if (res.data.length > 0) {
            this.list1 = res.data;
    ...
    //织机运转个数
    GetLoomStateData() {
      this.$store.dispatch("loom/LoomState", { park: "wucheng" }).then(
        (res) => {
          if (res.data.length == 1) {
    ...
    //当日开机率
    GetLoomOnRateData() {
      this.$store.dispatch("loom/LoomOnRate", { park: "wucheng" }).then(
        (res) => {
          if (res.data.length == 1) {
    ...
    //环境指数
    GetSewageIndexData() {
      this.$store.dispatch("others/SewageIndex", { park: "wucheng" }).then(
        (res) => {
          if (res.data.length == 1) {
    ...
    //水
    GetParkWaterData() {
      this.$store.dispatch("others/ParkWater", { park: "wucheng" }).then(
        (res) => {
          if (res.data.length == 1) {
    ...
    //电
    GetParkElectricData() {
      this.$store.dispatch("others/ParkElectric", { park: "wucheng" }).then(
        (res) => {
          if (res.data.length == 1) {
    ...
    GetParkEleWatDetailData() {
      this.$store.dispatch("others/ParkEleWatDetail", { park: "wucheng" }).then(
        (res) => {
          if (res.data.length > 0) {
            for (var i = 0; i < res.data.length; i++) {
