            ...
            <li class="menu-one-li">
              <div>
                ...
                <div class="icon-right">
                  ...
                  <p>织机总数<span class="count2" id="count17">456</span>台</p>
                  <p>织机运转<span class="count1" id="count18">428</span>台</p>
                </div>
              </div>
            </li>
            <li class="menu-one-li">
  ...
  export default {
    ...
    methods: {
      ...
      GetGreyProductionData() {
        this.$store
          .dispatch("greige/GreyProduction", {
            park: "dingxin",
          })
          .then(
            (res) => {
